    ...
    en: {
        translation: {
            ...
            pong: {
                ...
                devlog_beat1_body: 'The AI is a tiny neural network: 6 numbers go in (the ball’s position and speed, and both paddles) and 3 come out — up, down, stop. It just picks the biggest one. There is no rule of Pong coded anywhere: only 435 weights that turn what it sees into what it does.',
                devlog_beat2_title: 'The problem: it refused to learn',
                devlog_beat2_body: 'The first attempt used Evolution Strategies, and it kept collapsing. The network would freeze into a single action — always up, or always still — and hit nothing. The signals saturated and most random starts fell into a dead end. A lot of the work was measuring, proving it had collapsed, and understanding why.',
                devlog_beat3_title: 'The turn: natural selection',
                devlog_beat3_body: 'The fix was a Genetic Algorithm — literal Darwinian evolution. 60 random “brains” play; the best 30% become parents; the next generation inherits their weights through crossover and mutation. Elitism carries the champion untouched, so the best never regresses. In about 20 generations it already beats the opponent.',
                devlog_beat4_title: 'The catch: dense reward',
                devlog_beat4_body: 'But evolution only sees one score per match — so how does it know which move was good? The trick is in the reward: every paddle hit is worth points. Selection then favors brains whose plays worked as a whole — the way nature credits behavior, without ever isolating a single gesture.',
                devlog_beat5_title: 'From training to the live arena',
                devlog_beat5_body: 'Once trained, the network has to actually play. Elixir owns the game: it computes physics at 60fps and publishes state every 3 ticks. A Python service turns each state into an action and sends it back over RabbitMQ. The trick: the training environment steps at that same 3-tick cadence and shares the exact same physics code — so what the network learned holds up in the live arena, with no sim-to-real gap.',
            },
            philosophers: {
    ...
    pt: {
        translation: {
            ...
            pong: {
                ...
                devlog_beat1_body: 'A IA é uma rede neural minúscula: entram 6 números (a posição e a velocidade da bola, e as duas raquetes) e saem 3 — subir, descer, parar. Ela só escolhe o maior. Não há nenhuma regra de Pong codificada: só 435 pesos que transformam o que ela vê na ação que toma.',
                devlog_beat2_title: 'O problema: ela se recusava a aprender',
                devlog_beat2_body: 'A primeira tentativa usou Evolution Strategies, e ela vivia colapsando. A rede travava numa ação só — sempre pra cima, ou sempre parada — e não rebatia nada. Os sinais saturavam e a maioria dos inícios aleatórios caía num beco sem saída. Boa parte do trabalho foi medir, provar que tinha colapsado, e entender o porquê.',
                devlog_beat3_title: 'A virada: seleção natural',
                devlog_beat3_body: 'A solução foi um Algoritmo Genético — evolução darwiniana literal. 60 “cérebros” aleatórios jogam; os 30% melhores viram pais; a próxima geração herda seus pesos via cruzamento e mutação. O elitismo carrega o campeão intacto, então o melhor nunca regride. Em umas 20 gerações ele já bate o oponente.',
                devlog_beat4_title: 'O pulo do gato: recompensa densa',
                devlog_beat4_body: 'Mas a evolução só vê uma nota por partida — então como saber qual jogada foi boa? O truque está na recompensa: cada rebatida vale pontos. A seleção passa a favorecer cérebros cujas jogadas funcionaram no conjunto — do jeito que a natureza credita o comportamento, sem nunca isolar um gesto só.',
                devlog_beat5_title: 'Do treino pra arena ao vivo',
                devlog_beat5_body: 'Treinada, a rede precisa jogar de verdade. O Elixir é o dono do jogo: calcula a física a 60fps e publica o estado a cada 3 ticks. Um serviço em Python transforma cada estado numa ação e devolve pelo RabbitMQ. O pulo: o ambiente de treino anda na mesma cadência de 3 ticks e compartilha exatamente o mesmo código de física — então o que a rede aprendeu vale na arena ao vivo, sem gap sim-to-real.',
            },
            philosophers: {
                title: 'philosophers_lab',
